...
def staff_home(request):
    ...
    context = {
        'page_title': 'Панель учителя - ' + str(staff.admin.last_name) + ' (' + str(staff.course) + ')',
...
def staff_update_attendance(request):
    ...
    context = {
        'subjects': subjects,
        'sessions': sessions,
        'page_title': 'Обновить посещаемости'
    }
...
def staff_apply_leave(request):
    ...
    context = {
        ...
        'page_title': 'Заявление на отпуск'
    }
...
def staff_view_profile(request):
    ...
    context = {'form': form, 'page_title': 'Просмотр/обновление профиля'}
    if request.method == 'POST':
        try:
            if form.is_valid():
...
def staff_add_result(request):
    ...
    sessions = Session.objects.all()
    context = {
        'page_title': 'Выдача сертификатов',
        'subjects': subjects,
        'sessions': sessions
    }
    if request.method == 'POST':
